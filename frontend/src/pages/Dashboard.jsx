...
import { Users, UserCheck, UserMinus, Building2, TrendingUp } from 'lucide-react';
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-slate-500 mt-1">Summary of HR activity for your organization.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        {stats?.dept_stats?.map((dept, idx) => (
                            <div key={idx}>
                                <div className="flex justify-between text-sm mb-1">
                                    <span className="text-slate-600 dark:text-slate-400 font-medium">{dept.department}</span>
                ...
                <div className="bg-primary-600 p-8 rounded-2xl shadow-lg relative overflow-hidden group">
                    <div className="relative z-10">
                        ...
                        <p className="text-primary-100 mb-6 max-w-xs">Manage your team and track attendance efficiently from one place.</p>
                    ...
                    <Building2 size={160} className="absolute -right-8 -bottom-8 text-primary-500 opacity-20 group-hover:scale-110 transition-transform duration-500" />
                </div>
            </div>
        </div>
    );
